...
export default function SideNavBar() {
  ...
  return (
    <>
      ...
      <nav
        className={`fixed md:sticky top-0 md:top-14.25 left-0 h-full md:h-[calc(100vh-57px)] border-r border-outline-variant/30 py-6 md:py-4 px-4 md:px-3 bg-surface transition-all duration-450 ease-in-out overflow-hidden flex flex-col justify-between z-50 md:z-30 shadow-2xl md:shadow-none ${
          sidebarOpen
            ? 'w-60 md:w-45 translate-x-0 opacity-100 pointer-events-auto'
            : 'w-69 md:w-0 -translate-x-full md:translate-x-0 md:border-r-0 md:opacity-0 md:px-0 md:pointer-events-none'
        }`}
      >
        {/* Navigation list */}
        <div>
