...
export default function WriteBar({
  ...
  return (
    <header className="sticky top-0 z-40 bg-surface/95 backdrop-blur-md w-full">
      <div className="max-w-[1280px] md:w-[80%] w-full mx-auto flex justify-between items-center px-4 md:px-6 py-2 border-b border-outline-variant/30 select-none">
