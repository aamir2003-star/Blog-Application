                  ...
                  >
                    <div className="flex justify-between items-start gap-4">
                      <div className="space-y-1.5">
                        <span className="font-headline-lg text-sm font-bold text-on-surface hover:text-primary transition-colors leading-tight line-clamp-2">
                          {post.title}
                        </span>
                    ...
                    <div className="flex flex-wrap items-center gap-x-2.5 gap-y-1 text-[10px] text-on-surface-variant/80 font-medium select-none">
                      <span className="flex items-center gap-0.5">
                        <span className="material-symbols-outlined text-[12px] text-primary">visibility</span>
                        <span>{(post.totalViews ?? post.views ?? 0).toLocaleString()}</span>
                      </span>
                      <span className="text-outline-variant/40">•</span>
                      <span className="flex items-center gap-0.5">
                        <span className="material-symbols-outlined text-[12px] text-primary">groups</span>
                        <span>{(post.uniqueVisitors ?? 0).toLocaleString()}</span>
                      </span>
                      <span className="text-outline-variant/40">•</span>
                      <span className="flex items-center gap-0.5">
                        <span className="material-symbols-outlined text-[12px] text-primary">menu_book</span>
                        <span>{(post.reads ?? 0).toLocaleString()}</span>
                      </span>
                      <span className="text-outline-variant/40">•</span>
                      <span className="flex items-center gap-0.5">
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-outline-variant/5">
                      <span className="text-[10px] text-on-surface-variant select-none">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`font-label-caps text-[9px] uppercase font-bold tracking-wider select-none w-12 text-left ${
                          post.status === 'PUBLISHED' ? 'text-primary' : 'text-on-surface-variant/80'
                        }`}>
                          {post.status}
                        </span>
