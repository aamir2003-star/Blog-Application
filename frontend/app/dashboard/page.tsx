...
export default function CreatorDashboard() {
  ...
  const { 
    ...
    error: activeError 
  } = useMyPostsQuery(accessToken);

  const { 
    data: trashPostsData, 
    isLoading: trashLoading, 
    error: trashError 
  } = useTrashPostsQuery(accessToken);
    ...
    return (
      <div className="min-h-screen bg-surface flex flex-col items-center justify-center relative overflow-hidden">
        ...
        <div className="flex flex-col items-center gap-4 z-10 select-none">
          ...
          <p className="font-label-caps text-xs text-on-surface-variant font-semibold uppercase tracking-wider animate-pulse">
